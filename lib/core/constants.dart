...
const screenStyleConfig = {
  ...
  'landing': {
    ...
    'logoWidth': 300.0, // Largeur fixe du logo.
    'taglineFontSize': 35.0, // Taille du texte d'accroche.
    ...
    'buttonRadius': 10.0, // Rayon des coins des boutons.
    'primaryCtaFontSize': 16.0, // Taille de police du bouton principal.
    ...
    'primaryCtaIconSize': 36.0, // Taille de l'icône dans le bouton principal.
    ...
    'secondaryCtaFontSize': 16.0, // Taille de police du bouton secondaire.
    ...
    'indicatorSize': 15.0, // Taille des indicateurs (points/pastilles).
